System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, director, Label, GameManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _crd, ccclass, property, MenuManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("MenuManager", MenuManager = (_dec = ccclass('MenuManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = (_class3 = class MenuManager extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "lb_MainScore", _descriptor5, this);
        }
        ...
        gameEnd() {
          ...
          this.lb_MainScore.active = false;
          this.btn_pauseBtn.active = false;
        }
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "lb_MainScore", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=43bca01e1a263cbcbcb5532dc2137c334caee44a.js.map