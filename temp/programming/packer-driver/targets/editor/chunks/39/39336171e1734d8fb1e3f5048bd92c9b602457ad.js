System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, director, Label, GameManager, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _crd, ccclass, property, MenuManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("MenuManager", MenuManager = (_dec = ccclass('MenuManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec(_class = (_class2 = (_class3 = class MenuManager extends Component {
        constructor(...args) {
          super(...args);
        ...
        gameEnd() {
          ...
          this.lb_score.string = `您的分数为:${(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
...
//# sourceMappingURL=39336171e1734d8fb1e3f5048bd92c9b602457ad.js.map