System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, math, v3, instantiate, tween, Label, director, GameData, MenuManager, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _crd, ccclass, property, EnumGameStatus, GameManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Label), _dec(_class = (_class2 = (_class3 = class GameManager extends Component {
        constructor(...args) {
          super(...args);
        ...
        summonBricks() {
          ...
          let rand = math.randomRange(-(_crd && GameData === void 0 ? (_reportPossibleCrUseOfGameData({
            error: Error()
...

          {
            ...
            let pos = (_crd && GameData === void 0 ? (_reportPossibleCrUseOfGameData({
              error: Error()
            }), GameData) : GameData).data.brickHeight / 2 + 2000;
            let scale = 30 * (_crd && GameData === void 0 ? (_reportPossibleCrUseOfGameData({
              error: Error()
          ...
          if (GameManager.instance.allBricks.length > 8) {
            //判断队列长度
        ...
        checkTimer() {
          ...
          if (GameManager.instance.Timer < (_crd && GameData === void 0 ? (_reportPossibleCrUseOfGameData({
            error: Error()
          }), GameData) : GameData).data.brickSpawnTime) {
...
//# sourceMappingURL=eb4868ac864b7da8fb66f33bcd1ea8a451b37b61.js.map