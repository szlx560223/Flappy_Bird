System.register(["__unresolved_0", "cc"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, math, v3, instantiate, tween, Label, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, EnumGameStatus, GameManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Label), _dec5 = _decorator.type('MenuManager'), _dec(_class = (_class2 = class GameManager extends Component {
        constructor(...args) {
          super(...args);
...
//# sourceMappingURL=5315aff50f2e8101c9d1c07257960303704ab58c.js.map