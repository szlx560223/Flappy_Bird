  ...
  return {
    ...
    execute: function () {
      ...
      _export("Setting", Setting = class Setting {
        ...
        //障碍物宽度
        //越过障碍物的得分
        constructor(birdPos = 960, birdScale = 50, birdGravity = 2000, birdSpeedUpDamping = 0.6, birdSpeedDownDamping = 0, birdJumpStrength = 800, brickSpawnTime = 200, brickSpawnRand = 500, brickSpeed = 10, brickHeight = 250, brickWidth = 5, brickPoint = 1) {
          this.birdPos = void 0;
...
//# sourceMappingURL=3fed962353cf592d1eff62b76d15ef4873d9c14b.js.map