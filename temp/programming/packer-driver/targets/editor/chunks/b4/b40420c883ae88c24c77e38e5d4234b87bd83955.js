    ...
    execute: function () {
      ...
      _export("BirdCtrl", BirdCtrl = (_dec = ccclass('BirdCtrl'), _dec2 = property(Node), _dec3 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        start() {
          ...
          this.Bird.getComponent(SphereCollider).on('onTriggerEnter', this.onHit, this); //开启碰撞检测

          const coms = this.Bird.getComponents(SphereCollider);
          console.log(coms);
        } ///////////////////////////////////////////////
...
//# sourceMappingURL=b40420c883ae88c24c77e38e5d4234b87bd83955.js.map