System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, director, Label, EnumGameStatus, GameManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, MenuManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("MenuManager", MenuManager = (_dec = ccclass('MenuManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = _decorator.type(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        error: Error()
      }), GameManager) : GameManager), _dec5 = property(Label), _dec(_class = (_class2 = class MenuManager extends Component {
        constructor(...args) {
          super(...args);
...
//# sourceMappingURL=2fa1fcbd13f7389d265e557c56f5b98534f16afa.js.map