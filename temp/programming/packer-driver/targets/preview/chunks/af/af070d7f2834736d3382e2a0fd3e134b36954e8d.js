System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'RigidBody', 'v3', 'input', 'Input', 'EventMouse', 'PhysicsSystem', 'ICollisionEvent', 'SphereCollider']);
      ...
      _export("BirdCtrl", BirdCtrl = (_dec = ccclass('BirdCtrl'), _dec2 = property(Node), _dec(_class = (_class2 = class BirdCtrl extends Component {
        ...
        calculateAngle() {
          ...
          var x = 300 + (_crd && GameData === void 0 ? (_reportPossibleCrUseOfGameData({
            error: Error()
          }), GameData) : GameData).data.brickSpeed * 10; //x方向相对速度
          ...
          var num_angle = angle / 3.141592 * 180;
...
//# sourceMappingURL=af070d7f2834736d3382e2a0fd3e134b36954e8d.js.map