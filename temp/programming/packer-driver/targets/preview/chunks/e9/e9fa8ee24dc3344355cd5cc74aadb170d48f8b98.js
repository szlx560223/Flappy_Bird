    ...
    execute: function () {
      ...
      _export("BirdCtrl", BirdCtrl = (_dec = ccclass('BirdCtrl'), _dec2 = property(Node), _dec(_class = (_class2 = class BirdCtrl extends Component {
        ...
        init() {
          ...
          this.Bird.getComponent(RigidBody).linearDamping = 0; //设置速度阻尼
        ...
        getScore(event) {
          ...
          (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
          }), GameManager) : GameManager).instance.score = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
...
//# sourceMappingURL=e9fa8ee24dc3344355cd5cc74aadb170d48f8b98.js.map