System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, Node, Prefab, v3, instantiate, tween, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GameManager;
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class GameManager extends Component {
        ...
        summonBricks() {
          ...
          tween(newBrick).to(20, {
            position: v3(-2000, 0, 0)
          }).delay(500).start();
        }
...
//# sourceMappingURL=d8d7b41b78c202a24c44ba46545cd42b704e69cf.js.map