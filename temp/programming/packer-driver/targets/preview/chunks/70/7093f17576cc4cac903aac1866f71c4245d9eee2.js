System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, RigidBody, v3, input, Input, PhysicsSystem, SphereCollider, quat, EnumGameStatus, GameManager, GameData, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, BirdCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'RigidBody', 'v3', 'input', 'Input', 'EventMouse', 'PhysicsSystem', 'ICollisionEvent', 'SphereCollider', 'Vec3', 'math', 'quat']);
      ...
      _export("BirdCtrl", BirdCtrl = (_dec = ccclass('BirdCtrl'), _dec2 = property(Node), _dec(_class = (_class2 = class BirdCtrl extends Component {
        ...
        init() {
          ...
          var coms = this.Bird.getComponents(SphereCollider); //两个球体碰撞箱组件
        ...
        calculateAngel() {
          var x = 300 + (_crd && GameData === void 0 ? (_reportPossibleCrUseOfGameData({
            error: Error()
          ...
          var z = Math.atan(y / x);
          console.log(z);
          this.Bird.setRotation(quat(0, 0, z * 180, 0));
        }
...
//# sourceMappingURL=7093f17576cc4cac903aac1866f71c4245d9eee2.js.map